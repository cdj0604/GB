...
public class insert extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final EditText inputInt1 = (EditText) findViewById(R.id.edit02);
        final EditText inputInt2 = (EditText) findViewById(R.id.edit02);
        final EditText inputInt3 = (EditText) findViewById(R.id.edit03);

        Button saveint1 = (Button)findViewById(R.id.save01);
        Button saveInt2 = (Button) findViewById(R.id.save02);
        Button saveInt3 = (Button) findViewById(R.id.save03);
        ...
        saveint1.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View view){
        ...
        saveInt2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                setPreference(key02, Integer.parseInt(inputInt2.getText().toString()));
            }
        });
        saveInt3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
